...
class SongsOriginalSongDashboard < Administrate::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  # Overwrite this method to customize how songs original songs are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(songs_original_song)
  #   "SongsOriginalSong ##{songs_original_song.id}"
  # end
end
