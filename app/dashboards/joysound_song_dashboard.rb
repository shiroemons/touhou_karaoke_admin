...
class JoysoundSongDashboard < Administrate::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  # Overwrite this method to customize how joysound songs are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(joysound_song)
  #   "JoysoundSong ##{joysound_song.id}"
  # end
end
